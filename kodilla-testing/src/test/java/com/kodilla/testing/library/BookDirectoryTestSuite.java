...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOfNoRentedBooks() {
        ...
        when(libraryDatabaseMock.listBooksInHandsOf(any(LibraryUser.class))).thenReturn(emptyBookList);
        //When
    ...
    public void testListBooksInHandsOfOneRentedBook() {
        ...
        when(libraryDatabaseMock.listBooksInHandsOf(any(LibraryUser.class))).thenReturn(oneBookList);
        //When
        List<Book> theListOfBooks = bookLibrary.listBooksInHandsOf(any(LibraryUser.class));
        //Then
    ...
    public void testListBooksInHandsOfFiveRentedBooks() {
        ...
        when(libraryDatabaseMock.listBooksInHandsOf(any(LibraryUser.class))).thenReturn(fiveBookList);
        //When
        List<Book> theListOfBooks = bookLibrary.listBooksInHandsOf(isA(LibraryUser.class));
        //Then
